...
@Component
public class GameStoreInvoicingLayer {
    ...
    @Autowired
    public GameStoreInvoicingLayer(InvoiceRepository invoiceRepo, TaxRepository taxRepo, ProcessingFeeRepository processingFeeRepo, GameStoreCatalogClient catalogClient) {
